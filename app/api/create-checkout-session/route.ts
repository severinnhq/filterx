...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    // Add premium AI filtering line item for bundle plan
      ...
      lineItems.push({
        ...
        price_data: {
          ...
          product_data: {
            ...
            name: "Preorder lifetime access to Premium (AI Filtering)",

            description: "Filter with prompts.",

            metadata: {

              features: JSON.stringify({ ...features, aiFiltering: true }),

            },

          },

          unit_amount: 0, // Included in bundle price
